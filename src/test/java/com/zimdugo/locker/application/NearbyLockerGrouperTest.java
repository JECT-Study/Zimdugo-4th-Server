...
class NearbyLockerGrouperTest {
    ...
    @Test
    @DisplayName("동일 좌표면 하나의 그룹으로 묶는다")
    void groupsBySameCoordinate() {
        List<List<NearbyLocker>> result = nearbyLockerGrouper.groupByCoordinateOrRoadAddress(List.of(
            ...
            new NearbyLocker(2L, "강남B", "서울 B", 37.5, 127.0, 10.0, 1)
        ));
    ...
    @Test
    @DisplayName("동일 도로명 주소면 하나의 그룹으로 묶는다")
    ...
    @Test
    @DisplayName("좌표 미세 오차가 있어도 같은 그룹으로 묶는다")
