...
class LockerSearchQueryServiceTest {
    ...
    void returnsEmptyWhenNoNearbyLockers() {
        given(lockerSearchCandidateReader.search(37.55, 126.93, "신촌", 10))
    ...
    void returnsPlaceSuggestionWhenPlaceKeywordMatched() {
        ...
        verify(lockerSearchCandidateReader).search(37.55, 126.93, "신촌", 10);
    }
    ...
    void returnsLockerSuggestionWhenDetailKeywordMatched() {
        List<LockerSuggestCandidate> candidates = List.of(sampleCandidate());
        given(lockerSearchCandidateReader.search(37.55, 126.93, "신촌역1번출구b1", 10))
            .willReturn(LockerSearchCandidateResult.name(candidates));
        ...
        verify(lockerSearchCandidateReader).search(37.55, 126.93, "신촌역1번출구b1", 10);
    }
    ...
    void returnsPlaceSuggestionWhenAddressFallbackMatchedMultipleLockers() {
        List<LockerSuggestCandidate> candidates = List.of(sampleCandidate());
        given(lockerSearchCandidateReader.search(37.55, 126.93, "대구광역시", 10))
        ...
        verify(lockerSearchCandidateReader).search(37.55, 126.93, "대구광역시", 10);
    }
